...
while index < len(random_list):
    nbr = random_list[index]
    count_list[nbr] += 1
    index += 1

# my brilliant donkey solution; what if the list has 100 items?????!!!!!! stupid
#     if random_list[index] == 0:
#         count_list[0] += 1
#     if random_list[index] == 1:
#         count_list[1] += 1
#     if random_list[index] == 2:
#         count_list[2] += 1
#     if random_list[index] == 3:
#         count_list[3] += 1
#     if random_list[index] == 4:
#         count_list[4] += 1
#     if random_list[index] == 5:
#         count_list[5] += 1
#     if random_list[index] == 6:
#         count_list[6] += 1
#     if random_list[index] == 7:
#         count_list[7] += 1
#     if random_list[index] == 8:
#         count_list[8] += 1
#     if random_list[index] == 9:
#         count_list[9] += 1
#     if random_list[index] == 10:
#         count_list[10] += 1
#

# Check the list we created
print random_list, count_list
